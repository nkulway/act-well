  ...
  <div>
    ...
    <br/><Typography fontWeight="500" variant="p">1. You wake up and it's a beautiful Saturday morning. What do you do first?</Typography><br/>
        <div className="button-container">
            <Button className="button" variant="contained" onClick={() => handleClick(1)}>Look at your phone and go back to sleep</Button><br/>
            <Button className="button" variant="contained" onClick={() => handleClick(2)}>Message a couple of your friends to hangout</Button ><br/>  
            <Button className="button" variant="contained" onClick={() => handleClick(3)}>immediately get out of bed and do 10 push ups</Button ><br/>
        </div>
    </div>
    ...
    <br/><Typography fontWeight="500" variant="p">3. You're grocery shopping and take a look at your list. What's the first thing you need to get?</Typography><br/>
        <div className="button-container">
            <Button className="button" variant="contained" onClick={() => handleClick(1)}>Chamomile tea</Button><br/>
            <Button className="button" variant="contained" onClick={() => handleClick(2)}>Party hats and plates</Button ><br/>  
            <Button className="button" variant="contained" onClick={() => handleClick(3)}>Protien powder</Button >
        </div>
    </div>
      </>
